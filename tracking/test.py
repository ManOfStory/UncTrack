...
def main():
    ...
    parser.add_argument('--params__memory_size', type=int, default=3)
    parser.add_argument('--params__topk', type=int, default=3)
    parser.add_argument('--params__ppt', type=float, default=0.8)
