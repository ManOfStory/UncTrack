...
import numpy as np
from lib.test.tracker.unctrack_online import UncTrackOnline
from pytracking.ARcm_seg import ARcm_seg
from pytracking.vot20_utils import *

import lib.test.parameter.unctrack_online as votparams

class UNCTRACK_ALPHA_SEG(object):
...
refine_model_name = 'ARcm_coco_seg_only_mask_384.pth.tar'
params = votparams.parameters("baseline_large", model="unctrack_large_online.pth.tar")
# params = votparams.parameters("baseline")
unctrack = UncTrackOnline(params, "VOT20")
tracker = UNCTRACK_ALPHA_SEG(tracker=unctrack, refine_model_name=refine_model_name)
handle = vot.VOT("mask")
