...
"""
Add default config for UncTrack.
"""
cfg = edict()
...
cfg.MODEL.HEAD_TYPE = "UNC_CORNER"
...
cfg.MODEL.FEAT_SIZE = 18
cfg.MODEL.EMD_TYPE = 'EMBEDDER'
...
#DATA.MEMORY
cfg.DATA.MEMORY = edict()
cfg.DATA.MEMORY.GROUP = 3
cfg.DATA.MEMORY.SEARCH = edict()
cfg.DATA.MEMORY.SEARCH.CENTER_JITTER = 4.5
cfg.DATA.MEMORY.SEARCH.FACTOR = 4.5
cfg.DATA.MEMORY.SEARCH.SCALE_JITTER = 0.5
cfg.DATA.MEMORY.SEARCH.SIZE = 288
cfg.DATA.MEMORY.SEARCH.NUMBER = 1
cfg.DATA.MEMORY.TEMPLATE = edict()
cfg.DATA.MEMORY.TEMPLATE.CENTER_JITTER = 0
cfg.DATA.MEMORY.TEMPLATE.FACTOR = 2.0
cfg.DATA.MEMORY.TEMPLATE.SCALE_JITTER = 0
cfg.DATA.MEMORY.TEMPLATE.SIZE = 128
cfg.DATA.MEMORY.TEMPLATE.NUMBER = 2
# DATA.SEARCH
...
cfg.TEST.UPDATE_INTERVALS.GOT10K_TRAIN = [200]
...
cfg.TEST.ONLINE_SIZES.NAT2021 = [5]
